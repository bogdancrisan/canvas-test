...
View.formatImage = function(img, args) {
  ...
  args.width && (img.scaleX = args.width / img.width);
  args.height && (img.scaleY = args.height / img.height);
}
...
View.loadFromJSON = function (json, cb) {
  this.canvas.loadFromJSON(json, (cb || this.canvas.renderAll.bind(this.canvas)));
}
